...
$parametersearch = $_SESSION["search-portfolio"];
		...
		<?php
			...
			if( (!isset($_SESSION["login_user"])) && (empty($_SESSION["login_user"])) ){
                ...
                $sql = "SELECT itemID, itemName, itemDescription, itemType, itemPrice, itemImage 
		                FROM goodiegood
		                WHERE itemType = '".$parametersearch."'
		                OR itemName = '".$parametersearch."'
		                OR itemDescription LIKE '".$parametersearch."'";
